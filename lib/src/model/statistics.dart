...
class UserStatistics {
  String username;
  List<UserQuizResult> userQuizzes = [];
  ...
  factory UserStatistics.fromJson(String usr, Map<String, dynamic> json) {
    String username = usr;
    List<UserQuizResult> q = [];
    for (String str in json.keys) {
      q.add(UserQuizResult.fromJson(str, json[str]));
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    for (UserQuizResult q in userQuizzes) {
      m.addAll(q.toJson());
    }
  ...
  void addUserQuizzResult(UserQuizResult r) {
...
class UserQuizResult {
  ...
  UserQuizResult.fromJson(String name, Map<String, dynamic> json)
      : quizzName = name,
